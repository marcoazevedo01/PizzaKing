 ...
 * @author neto
 */
@WebServlet(name = "CarregarBebida", urlPatterns = {"/CarregarBebida"})
public class CarregarBebida extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            System.out.println("Erro ao carregar bebidaCTR " + e.getMessage());
        }
